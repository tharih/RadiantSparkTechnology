            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="infetech-about-content">
                        ...
                        <ul>
                            <li><i class="fal fa-check"></i> Friendly Service</li>
                            <li><i class="fal fa-check"></i> Domain and Hosting Services</li>
                        </ul>
                        
                        <ul>
                            <li><i class="fal fa-check"></i> Graphic Designing</li>
                            <li><i class="fal fa-check"></i> Software Reliability</li>
                        </ul>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="testimonial-slide-active-5">
                        <div class="testimonial-slide-item">
                            <div class="box">
                                <div class="thumb">
                                    <img src="assets/images/chamara.png" alt="" />
                                </div>
                                <div class="content">
                                    <h5 class="title">Chamara Sadamal </h5>
                                    <span>Livon Textile</span>
                                    <ul>
                            ...
                            <div class="text">
                                <p>We thank Radiant Spark Solution for the wonderful job in helping us develop our program. Everyone was professional, excellent and hard working. Thanks to them, we were able to achieve our goal on time, and we look forward to continue working with them in the future.</p>
                            </div>
                        </div>
                        <div class="testimonial-slide-item">
                            <div class="box">
                                <div class="thumb">
                                    <img src="assets/images/chubby.png" alt="" />
                                </div>
                                <div class="content">
                                    <h5 class="title">Chubby</h5>
                                    <span>Chubby Beats</span>
                                    <ul>
                                        <li><i class="fas fa-star"></i></li>
                                        <li><i class="fas fa-star"></i></li>
                                        <li><i class="fas fa-star"></i></li>
