                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="infetech-banner-content">
                            <h4 class="title" data-animation="fadeInDown" data-delay=".1s">Experience the best IT Solutions</h4>
                            <h1 class="" data-animation="fadeInLeft" data-delay=".3s">Create awesome digital experiences <img src="assets/images/banner-icon.png" alt="" /> <br /> quickly, easily, and securely</h1>
                            <a class="main-btn" data-animation="fadeInUp" data-delay=".6s" href="#">Learn More</a>
                            <img class="banner-arrow" data-animation="fadeInRight" data-delay=".9s" src="assets/images/banner-arrow.png" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="infetech-banner-content">
                            <h4 class="title" data-animation="fadeInDown" data-delay=".1s">Experience the best IT Solutions</h4>
                            <h1 class="" data-animation="fadeInLeft" data-delay=".3s">Catch up. Keep up.  <img src="assets/images/banner-icon.png" alt="" /> <br /> Pull ahead.</h1>
                            <a class="main-btn" data-animation="fadeInUp" data-delay=".6s" href="#">Learn More</a>
                            <img class="banner-arrow" data-animation="fadeInRight" data-delay=".9s" src="assets/images/banner-arrow.png" alt="" />
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="infetech-banner-content">
                            <h4 class="title" data-animation="fadeInDown" data-delay=".1s">Experience the best IT Solutions</h4>
                            <h1 class="" data-animation="fadeInLeft" data-delay=".3s">The Premier Product <br /> Development Partner</h1>
                            <a class="main-btn" data-animation="fadeInUp" data-delay=".6s" href="#">Learn More</a>
                            <img class="banner-arrow" data-animation="fadeInRight" data-delay=".9s" src="assets/images/banner-arrow.png" alt="" />
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="infetech-about-thumb animated wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="0ms">
                        ...
                        <img class="about-logo" src="assets/images/about.png" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="infetech-about-content">
                        ...
                        <p>Web designing is a powerful way of just not an only professions, however, in a passion for our Company. We have to a tendency to believe the idea that smart looking of any website is the first impression on visitors. And the smart design of any website is the starting point</p>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="about-card">
                                    ...
                                    <div class="content">
                                        <h4 class="title">POS Development</h4>
                                    </div>
                                </div>
                        ...
                        <ul>
                            <li><i class="fas fa-check-circle"></i> Experience Developing Crew</li>
                            <li><i class="fas fa-check-circle"></i> Domain and Hosting Services</li>
            ...
            <div class="row infetech-feature-slide">
                <div class="col-lg-2">
                    <div class="single-infetech-feature-item">
                        ...
                        <div class="content">
                            ...
                            <p>We are expert to create an efficient for user interface that makes design user interaction lively.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="single-infetech-feature-item">
                        ...
                        <div class="content">
                            <h4 class="title"><a href="#">IT <br/> Management</a></h4>
                            <p>We provide all all kind of IT management services of in the according to on their organization prioritie.</p>
                        </div>
                    </div>
                </div>
                {/* <div class="col-lg-2">
                ...
                <div class="col-lg-2">
                    <div class="single-infetech-feature-item">
                        ...
                        <div class="content">
                            <h4 class="title"><a href="#">Cloud <br/> Services</a></h4>
                            <p>We develop, migrate and work on web applications to ensure that they run on capably on clouds.</p>
                        </div>
                    </div>
                </div>
            </div>
